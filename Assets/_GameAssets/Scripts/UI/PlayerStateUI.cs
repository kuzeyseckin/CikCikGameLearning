...
public class PlayerStateUI : MonoBehaviour
{
    ...
    public RectTransform GetPlayerSpeedTransform => _boosterSpeedTransform;
    ...
    private void Start()
    {
        _playerController.onPlayerStateChanged += PlayerController_OnPlayerStateChaned;
        SetStateUserInterface(_playerSlidingActiveSprite, _playerSlidingPassiveSprite, _playerWalkingTransform, _playerSlidingTransform);
    }

    private void PlayerController_OnPlayerStateChaned(PlayerState playerState)
    {
        switch (playerState)
        {
            ...
            case PlayerState.Slide:
                SetStateUserInterface(_playerSlidingPassiveSprite, _playerSlidingActiveSprite, _playerSlidingTransform,_playerWalkingTransform);
                break;
        }
    }
